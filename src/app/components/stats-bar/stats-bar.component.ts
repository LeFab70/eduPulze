...
@Component({
  ...
  template: `
    <section class="bg-ep-navy text-white py-10 relative overflow-hidden">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative grid grid-cols-2 lg:grid-cols-4 gap-6">
        @for (stat of stats; track stat.label; let i = $index) {
          <div class="text-center space-y-1" epReveal="up" [epDelay]="i * 90">
