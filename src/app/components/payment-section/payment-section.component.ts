      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-[28px] p-6 sm:p-8 border border-slate-100 shadow-poster grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch" epReveal>
          ...
          <div class="lg:col-span-6 space-y-6 flex flex-col justify-between">
            ...
            <div class="bg-ep-navy text-white rounded-2xl p-6 space-y-4">
              <div class="flex items-center gap-3">
                ...
                <span class="text-base font-extrabold font-heading">Paiement sécurisé</span>
              </div>
              <div class="flex items-center gap-3">
                <div class="w-8 h-8 rounded-full bg-ep-green text-white flex items-center justify-center font-bold text-sm shrink-0">✓</div>
                <span class="text-base font-extrabold font-heading">Reçus instantanés</span>
              </div>
              <div class="flex items-center gap-3">
                <div class="w-8 h-8 rounded-full bg-ep-green text-white flex items-center justify-center font-bold text-sm shrink-0">✓</div>
                <span class="text-base font-extrabold font-heading">Paiement à votre rythme</span>
              </div>
          ...
          <div class="lg:col-span-6" epReveal="right" [epDelay]="120">
            <div class="relative rounded-2xl overflow-hidden h-full min-h-[320px] sm:min-h-[420px]">
              <img
                src="/assets/parent-salon-paiement.jpg"
                alt="Parent réglant la scolarité depuis son salon, une tasse de thé devant lui"
                class="absolute inset-0 w-full h-full object-cover object-[center_20%]"
              />
              <div class="absolute inset-0 bg-gradient-to-t from-ep-navy/70 via-transparent to-transparent"></div>
              <p class="absolute bottom-4 left-4 right-4 text-white text-sm sm:text-base font-semibold">
                La scolarité se règle en quelques secondes, depuis le salon.
              </p>
            </div>
          </div>
        </div>
