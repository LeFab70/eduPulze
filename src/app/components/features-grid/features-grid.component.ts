    ...
    <section id="features" class="relative bg-white pt-10 pb-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          <article class="text-center group" epReveal [epDelay]="0">
          ...
          <article class="text-center group" epReveal [epDelay]="120">
          ...
          <article class="text-center group" epReveal [epDelay]="240">
          ...
          <article class="text-center group" epReveal [epDelay]="360">
